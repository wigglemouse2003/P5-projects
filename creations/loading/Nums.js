...
//   translate(width / 4, height / 4);
        ...
        return loadSegs.seg5.show(digit, 1);
    }

    this.three = function() {
//   translate(width / 4, height / 4);

        return loadSegs.seg6.show(digit, 1);
    }
...
//   translate(width / 4, height / 4);
        ...
        return loadSegs.seg7.show(digit, 1);
    }

    this.six = function() {
//   translate(width / 4, height / 4);

        return loadSegs.seg4.show(digit, 1);
    }

    this.seven = function() {
//   translate(width / 4, height / 4);

        return loadSegs.seg3.show(digit, 1);
    }
